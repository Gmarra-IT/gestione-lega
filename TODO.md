Salvare uno snapshot, come testo sul db se è la miglior cosa, del file importato in fase di inserimento tramite pdf. Non dev'essere un dato operativo, ma ha piu funzione di log per sapere eventualmente se si è partiti da un'importazione errata o cosa. Non valuterei il salvataggio del file, per non ragionare di file fisici al momento.
